        ...
        <div className="bg-gray-50 dark:bg-gray-800 h-screen">
            <div className="flex h-full flex-1 flex-col justify-center px-10 py-14">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="relative z-0 w-full mb-6 group">
                        <input
                            ...
                            className={`block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 ${repeatPassword === "" ? 'border-gray-300' : formData.password === repeatPassword ? 'border-green-500' : 'border-red-500'
                                } border-b-2 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer`}
                            placeholder=" "
                            required
                        />
                        <label
                    ...
                    <div className="grid md:grid-cols-2 md:gap-6">
                        <div className="relative z-0 w-full mb-6 group">
                            {/* Use InputMask para formatar o número de telefone */}
                            <InputMask
                                mask="(99) 99999-9999"
                                type="tel"
                                name="phone"
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                            {/* Use InputMask para formatar o CRM */}
                            <InputMask
                                mask="9999999"
                                type="text"
                                name="crm"
