...
export default function Sidebar() {
    ...
    return (
        <aside id="logo-sidebar" className="fixed top-0 left-0 z-[38] w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
            <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
                <ul className="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="/dashboard/doencas" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span className="flex-1 ml-3 whitespace-nowrap">Doenças</span>
                ...
                <ul className="items-end">
                    ...
                    <button
                        className="fixed top-4 right-4 px-3 py-2 rounded-full bg-gray-800 text-white dark:text-gray-800 dark:bg-white"
                    ...
                    />
                        ...
                        <li>
                            <div className={`flex items-center justify-center p-2 text-gray-900 rounded-lg ${darkMode ? "dark:text-white" : ""} hover:bg-gray-100 ${darkMode ? "dark:hover:bg-gray-700" : ""} group`}>
